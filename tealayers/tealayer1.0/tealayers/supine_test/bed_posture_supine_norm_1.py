...
exp_i_data = helper.load_exp_i_supine_norm_1("../dataset/experiment-i")
...
for i in range(len(train_data.samples)):
    ...
    # train_data.samples[i] = cv2.equalizeHist(train_data.samples[i]*thresh1)
...
for i in range(len(test_data.samples)):
    ...
    # # img_eros = cv2.erode(thresh1,kernel,iterations=1)
    # # img_dila = cv2.dilate(img_eros,kernel,iterations=1)
    # test_data.samples[i]= cv2.equalizeHist(test_data.samples[i]*thresh1)
...
flattened_inputs_1 = Lambda(lambda x : x[:,      :1024])(flattened_inputs)
flattened_inputs_2 = Lambda(lambda x : x[:,1*2048:1*2048+1024])(flattened_inputs)
flattened_inputs_3 = Lambda(lambda x : x[:,2*2048:2*2048+1024])(flattened_inputs)
flattened_inputs_4 = Lambda(lambda x : x[:,3*2048:3*2048+1024])(flattened_inputs)
flattened_inputs_5 = Lambda(lambda x : x[:,4*2048:4*2048+1024])(flattened_inputs)
flattened_inputs_6 = Lambda(lambda x : x[:,5*2048:5*2048+1024])(flattened_inputs)
flattened_inputs_7 = Lambda(lambda x : x[:,6*2048:6*2048+1024])(flattened_inputs)
