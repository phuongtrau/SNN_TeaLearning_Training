...
for i in range(len(test_data)):
    ...
    e_1 = fft_trans(np.array(test_data[i]>=mask*25).astype(float))
    e_2 = fft_trans(np.array(test_data[i]>=mask*50).astype(float))
    e_3 = fft_trans(np.array(test_data[i]>=mask*75).astype(float))
    e_4 = fft_trans(np.array(test_data[i]>=mask*100).astype(float))
    e_5 = fft_trans(np.array(test_data[i]>=mask*125).astype(float))
    e_6 = fft_trans(np.array(test_data[i]>=mask*150).astype(float))
    e_7 = fft_trans(np.array(test_data[i]>=mask*175).astype(float))
    e_8 = fft_trans(np.array(test_data[i]>=mask*200).astype(float))
    e_9 = fft_trans(np.array(test_data[i]>=mask*225).astype(float))

    # cv2.imwrite("/home/hoangphuong/Documents/image_fashion/{}_mask_1.jpg".format(i),e_1*255)
    # cv2.imwrite("/home/hoangphuong/Documents/image_fashion/{}_mask_2.jpg".format(i),e_2*255)
    # cv2.imwrite("/home/hoangphuong/Documents/image_fashion/{}_mask_3.jpg".format(i),e_3*255)
    # cv2.imwrite("/home/hoangphuong/Documents/image_fashion/{}_mask_4.jpg".format(i),e_4*255)
    # cv2.imwrite("/home/hoangphuong/Documents/image_fashion/{}_mask_5.jpg".format(i),e_5*255)
    # cv2.imwrite("/home/hoangphuong/Documents/image_fashion/{}_mask_6.jpg".format(i),e_6*255)
    # cv2.imwrite("/home/hoangphuong/Documents/image_fashion/{}_mask_7.jpg".format(i),e_7*255)
    # cv2.imwrite("/home/hoangphuong/Documents/image_fashion/{}_mask_8.jpg".format(i),e_8*255)
    # cv2.imwrite("/home/hoangphuong/Documents/image_fashion/{}_mask_9.jpg".format(i),e_9*255)
