...
# import sys
# sys.path.append("/home/phuongdh/Documents/SNN/SNN_TeaLearning_Training/rancutils/rancutils")
...
model.fit(x_train, y_train,batch_size=64,epochs=50,verbose=1,validation_split=0.2)
