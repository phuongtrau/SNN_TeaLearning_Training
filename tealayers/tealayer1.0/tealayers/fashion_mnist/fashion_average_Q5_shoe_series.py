...
for i in range(len(train_data)):
    if train_label[i] == 5 or train_label[i]==7 or train_label[i]== 9:
...
for i in range(len(test_data)):
    ...
    if test_label[i] == 5 or test_label[i]==7 or test_label[i]== 9:
...
# model.load_weights('./ckpt_fashion/3_class_fashion-epoch-20')
