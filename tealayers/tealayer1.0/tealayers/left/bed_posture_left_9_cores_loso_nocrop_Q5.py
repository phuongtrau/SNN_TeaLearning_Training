...
for sub in ls_train_full:
  ...
  for i in range(len(train_data.samples)):
      ...
      e_1 = np.array(train_data.samples[i]>=mask*45).astype(float)
      e_2 = np.array(train_data.samples[i]>=mask*90).astype(float)
      e_3 = np.array(train_data.samples[i]>=mask*135).astype(float)
      e_4 = np.array(train_data.samples[i]>=mask*180).astype(float)
      e_5 = np.array(train_data.samples[i]>=mask*225).astype(float)
  ...
  for i in range(len(test_data.samples)):
      ...
      e_1 = np.array(test_data.samples[i]>=mask*45).astype(float)
      e_2 = np.array(test_data.samples[i]>=mask*90).astype(float)
      e_3 = np.array(test_data.samples[i]>=mask*135).astype(float)
      e_4 = np.array(test_data.samples[i]>=mask*180).astype(float)
      e_5 = np.array(test_data.samples[i]>=mask*225).astype(float)
