...
for sub in ls_train_full:
  ...
  for i in range(len(train_data.samples)):
      ...
      e_1 = np.array(train_data.samples[i]>=mask*32).astype(float)
      e_2 = np.array(train_data.samples[i]>=mask*64).astype(float)
      e_3 = np.array(train_data.samples[i]>=mask*96).astype(float)
      e_4 = np.array(train_data.samples[i]>=mask*128).astype(float)
      e_5 = np.array(train_data.samples[i]>=mask*160).astype(float)
      e_6 = np.array(train_data.samples[i]>=mask*192).astype(float)
      e_7 = np.array(train_data.samples[i]>=mask*224).astype(float)
  ...
  for i in range(len(test_data.samples)):
      ...
      e_1 = np.array(test_data.samples[i]>=mask*32).astype(float)
      e_2 = np.array(test_data.samples[i]>=mask*64).astype(float)
      e_3 = np.array(test_data.samples[i]>=mask*96).astype(float)
      e_4 = np.array(test_data.samples[i]>=mask*128).astype(float)
      e_5 = np.array(test_data.samples[i]>=mask*160).astype(float)
      e_6 = np.array(test_data.samples[i]>=mask*192).astype(float)
      e_7 = np.array(test_data.samples[i]>=mask*224).astype(float)
  ...
  x1_1_1 = Average()([x1_1,x1_2,x1_3,x1_4,x1_5,x1_6,x1_7])
  x2_1_1 = Average()([x2_1,x2_2,x2_3,x2_4,x2_5,x2_6,x2_7])
  x3_1_1 = Average()([x3_1,x3_2,x3_3,x3_4,x3_5,x3_6,x3_7])
  x4_1_1 = Average()([x4_1,x4_2,x4_3,x4_4,x4_5,x4_6,x4_7])
  x5_1_1 = Average()([x5_1,x5_2,x5_3,x5_4,x5_5,x5_6,x5_7])
  x6_1_1 = Average()([x6_1,x6_2,x6_3,x6_4,x6_5,x6_6,x6_7])
  x7_1_1 = Average()([x7_1,x7_2,x7_3,x7_4,x7_5,x7_6,x7_7])
  x8_1_1 = Average()([x8_1,x8_2,x8_3,x8_4,x8_5,x8_6,x8_7])
  x9_1_1 = Average()([x9_1,x9_2,x9_3,x9_4,x9_5,x9_6,x9_7])
  x10_1_1 = Average()([x10_1,x10_2,x10_3,x10_4,x10_5,x10_6,x10_7])
  x11_1_1 = Average()([x11_1,x11_2,x11_3,x11_4,x11_5,x11_6,x11_7])
  x12_1_1 = Average()([x12_1,x12_2,x12_3,x12_4,x12_5,x12_6,x12_7])
  x13_1_1 = Average()([x13_1,x13_2,x13_3,x13_4,x13_5,x13_6,x13_7])
  x14_1_1 = Average()([x14_1,x14_2,x14_3,x14_4,x14_5,x14_6,x14_7])
  x15_1_1 = Average()([x15_1,x15_2,x15_3,x15_4,x15_5,x15_6,x15_7])
  x16_1_1 = Average()([x16_1,x16_2,x16_3,x16_4,x16_5,x16_6,x16_7])
