...
datasets_3_class = {"Base":exp_i_data_right}
...
#### 3_Classes ####
    ...
    for i in range(len(test_data_3_class.samples)):
        ...
        x_test_3_class.append(test_data_3_class.samples[i])
...
#### Merge Output ####
    ...
    model_all.load_weights('bed_posture/ckpt_17_classes_21_cores/17_classes-{}'.format(sub))
